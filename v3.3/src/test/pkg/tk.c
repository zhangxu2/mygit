...
int main(int argc, char* argv[])
{
	...
	sw_char_t	path[256] = {"key_value.xml"};
	...
	***/
	...
	loc_set_zd_data(&comm_vars, "#InputBrc", "10086");                                     
	loc_set_zd_data(&comm_vars, "#InputTeller", "20099"); 
	loc_set_zd_data(&comm_vars, "#CustomerName", "马伟伟");                                          
	loc_set_zd_data(&comm_vars, "#PhoneNumber", "99568");                                 
	loc_set_zd_data(&comm_vars, "#Address", "XI'AN");                              
	loc_set_zd_data(&comm_vars, "#InterestDate", "2013-10-10");                                       
	loc_set_zd_data(&comm_vars, "#Amount", "1000.00");                                          
	loc_set_zd_data(&comm_vars, "#Currency", "CNY"); 	
